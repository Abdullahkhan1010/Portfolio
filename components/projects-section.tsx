...
const projects = [
  ...
  },
  {
    ...
    description: "Cross-platform mobile app with workout logging, progress tracking, and real-time Firebase sync.",
    image: "/fitness-app.png",
    category: "mobile",
    technologies: ["Flutter", "Firebase", "Dart", "Google Analytics", "Cloud Functions"],
    demoUrl: "#",
    codeUrl: "#",
  },
  {
    ...
    description:
      "Full-featured online store with user authentication, product catalog, search, and checkout system.",
    image: "/ecommerce-store.png",
    category: "web",
    technologies: ["React", "MongoDB", "JavaScript", "HTML/CSS", "Express.js"],
    demoUrl: "#",
    codeUrl: "#",
  },
  {
    id: 5,
    title: "Music Player",
    description: "Web-based music player with C++ backend, playlists, and audio streaming capabilities.",
    image: "/music-player.png",
    category: "web",
    technologies: ["C++", "HTML/CSS", "JavaScript", "Audio Processing", "File Management"],
    demoUrl: "#",
    codeUrl: "#",
  }
]
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-20">
        ...
        >
          <Button
            ...
            asChild
          >
            <Link href="https://github.com/Abdullahkhan1010" target="_blank" rel="noopener noreferrer">
