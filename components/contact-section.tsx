...
export function ContactSection() {
  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      value: "abdullah.khan1010@gmail.com",
      link: "mailto:abdullah.khan1010@gmail.com",
    },
    {
      icon: <Phone className="h-6 w-6" />,
      title: "Phone",
      value: "+92 314 1966559",
      link: "tel:+923141966559",
    },
    {
  ...
  const socials = [
    {
      name: "Github",
      url: "https://github.com/Abdullahkhan1010",
      icon: <Github className="h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6" />,
    },
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/abdullah-khan-webdev/",
      icon: <Linkedin className="h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6" />,
    },
    {
      name: "Email",
      url: "mailto:abdullah.khan1010@gmail.com",
