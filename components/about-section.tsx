...
export function AboutSection() {
  ...
  const tabs = [
    { 
      ...
      name: "Development",
      content: "I build scalable full-stack applications using React, Next.js, and Flutter with a focus on performance, accessibility, and user experience. My code is clean, maintainable, and follows industry best practices."
    },
    { 
      icon: <Globe className="h-5 w-5" />,
      name: "Experience",
      content: "As a Full Stack Developer, I've architected high-performance web solutions for diverse clients including Shopify stores and fitness platforms. Currently managing Shopify operations at Magasin Daata and developing fitness platforms. Skilled in translating business requirements into elegant technical solutions."
    },
    { 
      icon: <Database className="h-5 w-5" />,
      name: "Skills",
      content: "My expertise spans Frontend (React, Next.js, Flutter), Backend (Node.js, C++, C#, .NET), and Databases (MongoDB, Firebase, PostgreSQL). I'm proficient with tools like GSAP, Tailwind CSS, and performance optimization techniques including code splitting and lazy loading."
    },
    { 
      icon: <Puzzle className="h-5 w-5" />,
      name: "Process",
      content: "I approach projects with a mobile-first, user-centered mindset, combining design thinking with technical excellence. Every project is optimized for performance (90+ PageSpeed scores), accessibility (100% WCAG compliance), and maintainability through iterative development."
    },
  ]
