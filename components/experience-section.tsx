...
const experiences = [
  {
    ...
    description:
      "Custom Shopify storefront with dynamic cart modules, product filtering, and 90+ PageSpeed optimization.",
  },
  {
    type: "education",
    ...
    period: "2023 - Present",
    description: "Focus on modern web and mobile application development.",
  },
  {
    type: "education",
    ...
    location: "Islamabad, Pakistan",
    period: "2020 - 2022",
    description: "Information & Communication Technology with strong math and programming foundation.",
  },
  {
    type: "education",
    title: "Matriculation",
    company: "SLS Montessori and School",
    location: "Islamabad, Pakistan",
    period: "2018 - 2020",
    description: "Secondary education with distinction in science.",
  },
]
