        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-4 items-center">
          ...
          >
            <div className="space-y-6 max-w-xl mx-auto lg:ml-0">
              ...
              >
                {[
                  { icon: <Github className="h-5 w-5" />, href: "https://github.com/Abdullahkhan1010" },
                  { icon: <Linkedin className="h-5 w-5" />, href: "https://www.linkedin.com/in/abdullah-khan-webdev/" },
                  { icon: <Mail className="h-5 w-5" />, href: "mailto:abdullah.khan1010@gmail.com" }
                ].map((social, index) => (
                  <motion.a 
                    key={index}
                    href={social.href} 
